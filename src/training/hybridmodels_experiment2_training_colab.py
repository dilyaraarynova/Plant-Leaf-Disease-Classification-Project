...
print("✓ Stabilized augmentation transforms defined!")
...
print("✓ Class weights calculated and ready for the loss function.")
...
print(f"✓ Loaded best fold model")
...
print(f"\n✓ Metrics saved to {MODEL_NAME}_scenario2_metrics.json")
...
ax6.axis('off')
summary_data = [
    ['CV Mean', f"{np.mean(fold_results):.2f}% ± {np.std(fold_results):.2f}%"],
...
print(f"✓ Comprehensive metrics visualization saved!")
...
print(f"✓ CV results visualization saved!")
...
with open(f'/content/{MODEL_NAME}_scenario2_cv_summary.txt', 'w') as f:
    ...
    f.write(f"\n  Mean: {np.mean(fold_results):.2f}% ± {np.std(fold_results):.2f}%\n")
